...
*/
SELECT count(id) AS 'Количество сотрудников' FROM staff  
...
*/
SELECT post AS 'Средний возраст менее 30' FROM staff 
GROUP BY post
HAVING AVG(age)<30;